...
const PATHS = {
  ...
  area: ["M4 9V4h5", "M20 9V4h-5", "M4 15v5h5", "M20 15v5h-5"],
  // money & markets
  ...
  coins: ["M12 8.5c3.9 0 7-1.2 7-2.75S15.9 3 12 3 5 4.2 5 5.75 8.1 8.5 12 8.5z", "M5 5.75v6.5c0 1.55 3.1 2.75 7 2.75s7-1.2 7-2.75v-6.5", "M5 12.25v6c0 1.55 3.1 2.75 7 2.75s7-1.2 7-2.75v-6"],
  chart: ["M4 4v16h16", "M8 15l3-3 3 2 4-5"],
  pie: ["M12 3a9 9 0 109 9h-9z", "M12 12V3"],
  ...
  receipt: ["M6 3h12v18l-2-1.5-2 1.5-2-1.5-2 1.5-2-1.5-2 1.5z", "M9 8h6", "M9 12h6"],
  // trust & compliance
  ...
  idcard: ["M3 6h18v12H3z", "M7 10.5a1.8 1.8 0 100-3.6 1.8 1.8 0 000 3.6z", "M5.5 15.5a3 3 0 013-2h.4a3 3 0 013 2", "M14 9.5h4", "M14 13h4"],
  ...
  calendar: ["M4 6.5a2 2 0 012-2h12a2 2 0 012 2V19a2 2 0 01-2 2H6a2 2 0 01-2-2z", "M4 9.5h16", "M8 3v3", "M16 3v3"],
  ...
  search: ["M11 18a7 7 0 100-14 7 7 0 000 14z", "M16 16l4.5 4.5"],
