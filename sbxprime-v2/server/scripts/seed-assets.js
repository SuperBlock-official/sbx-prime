...
const ASSETS = [
  {
    ...
    data: {
      ...
      images: { hero: img("grosvenor-hero.jpg"), gallery: [img("grosvenor-1.jpg"), img("grosvenor-2.jpg"), img("grosvenor-3.jpg"), img("grosvenor-4.jpg"), img("grosvenor-5.jpg"), img("grosvenor-6.jpg")] },
  ...
  },
  {
    ...
    data: {
      ...
      images: { hero: img("threadneedle-hero.jpg"), gallery: [img("threadneedle-1.jpg"), img("threadneedle-2.jpg"), img("threadneedle-3.jpg"), img("threadneedle-4.jpg"), img("threadneedle-5.jpg"), img("threadneedle-6.jpg")] },
  ...
  },
  {
    ...
    data: {
      ...
      images: { hero: img("chiswell-hero.jpg"), gallery: [img("chiswell-1.jpg"), img("chiswell-2.jpg"), img("chiswell-3.jpg"), img("chiswell-4.jpg"), img("chiswell-5.jpg"), img("chiswell-6.jpg")] },
  ...
  },
  {
    ...
    data: {
      ...
      images: { hero: img("vauxhall-hero.jpg"), gallery: [img("vauxhall-1.jpg"), img("vauxhall-2.jpg"), img("vauxhall-3.jpg"), img("vauxhall-4.jpg"), img("vauxhall-5.jpg"), img("vauxhall-6.jpg")] },
  ...
  },
  {
    ...
    data: {
      ...
      images: { hero: img("dover-hero.jpg"), gallery: [img("dover-1.jpg"), img("dover-2.jpg"), img("dover-3.jpg"), img("dover-4.jpg"), img("dover-5.jpg"), img("dover-6.jpg")] },
